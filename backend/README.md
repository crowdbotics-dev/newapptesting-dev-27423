...
## Project Structure
    ...
    ├── newapptesting_dev_27423  # Django project configurations
...
1. Clone this repo and `cd newapptesting_dev_27423`
...
2. Clone this repo and `cd newapptesting_dev_27423`
